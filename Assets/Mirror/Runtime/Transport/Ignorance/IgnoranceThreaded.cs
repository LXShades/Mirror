...
namespace Mirror
{
    public class IgnoranceThreaded : Transport
    {
        ...
        // Debug simulation
        [Header("Debug")]
        [Tooltip("Enables latency simulation for clients. This adds receive latency to clients only, servers are unaffected.")]
        public Endpoint EnableLatencySimulation = 0;
        [Range(0, 500)]
        public int LatencySimulationDelayMs = 100;
        [Range(0, 500)]
        public int LatencySimulationJitterMs = 0;
...
#region Unity Editor and Sanity Checks
        ...
        private struct IncomingPacket
        {
            ...
            public long arrivalTime;                // DateTime.Now.Ticks when the packet arrived
            internal int length;
        }
